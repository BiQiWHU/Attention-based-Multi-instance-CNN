...
def input_pipeline(filename, batch_size, is_shuffle=True, is_train=True):
    ...
    if is_shuffle:
        ...
        example_batch, label_batch = tf.train.batch([example, label], batch_size=batch_size, capacity=capacity, num_threads=1)
    return example_batch, label_batch


if __name__ == '__main__':
    get_records("D:/Dataset/AID_dataset/AID", ext='jpg')
